...
export const de: Dict = {
  ...
  'settings.update.latest': 'Update verfügbar ({version})',
  'settings.update.available': 'Update verfügbar',
  'settings.update.current': '✓ Aktuell (v{version})',
  'settings.update.running': 'Update läuft…',
  'settings.update.uptodate': '✅ Bereits aktuell — nichts zu installieren',
  'settings.update.installed': '✅ Update installiert — Dienst startet neu',
  'settings.update.failed': '❌ Update fehlgeschlagen',
  'settings.update.button': 'Jetzt updaten',
  'settings.update.button.running': 'Update läuft…',
  'settings.update.startedToast': 'Update gestartet',
  'settings.update.failedToast': 'Update fehlgeschlagen',
  'settings.hermesUpdate.startedToast': 'Hermes-Update gestartet',
  'settings.hermesUpdate.failedToast': 'Hermes-Update fehlgeschlagen',
  'settings.hermesUpdate.title': 'Hermes Agent Update',
  'settings.hermesUpdate.button': 'Hermes updaten',
