...
export const en: Dict = {
  ...
  'telegram.setup.restartHint':
    'A token or allowed-users change only takes effect after the gateway restarts — it only reads these values at its own startup.',
  'telegram.setup.restartHintAfterSave':
    'Saved — but the gateway won’t use this until it restarts. Restart it now to apply the change.',
  'telegram.setup.restartButton': 'Restart gateway',
  'telegram.setup.restartConfirm':
    'This briefly takes every messaging platform on this profile offline, not just Telegram, while the gateway comes back up. Continue?',
  'telegram.setup.restartStartedToast':
    'Gateway restart started — test the connection in a few seconds.',
  ...
  'settings.update.latest': 'Update available ({version})',
  'settings.update.available': 'Update available',
  'settings.update.current': '✓ Up to date (v{version})',
  'settings.update.running': 'Updating…',
  'settings.update.uptodate': '✅ Already up to date — nothing to install',
  'settings.update.installed': '✅ Update installed — service restarts',
  'settings.update.failed': '❌ Update failed',
  'settings.update.button': 'Update now',
  'settings.update.button.running': 'Updating…',
  'settings.update.startedToast': 'Update started',
  'settings.update.failedToast': 'Update failed',
  'settings.hermesUpdate.startedToast': 'Hermes update started',
  'settings.hermesUpdate.failedToast': 'Hermes update failed',
  'settings.hermesUpdate.title': 'Hermes Agent Update',
  'settings.hermesUpdate.button': 'Update Hermes',
  'settings.ccUpdate.title': 'Control Center Update',
  ...
  'donation.sol.subtitle': 'USDC or USDT only — not SOL',
  'donation.sol.warning': 'Solana network, USDC/USDT only — never SOL or an EVM chain.',
  'donation.ton.title': 'TON',
  'donation.ton.subtitle': 'USDT only',
  'donation.ton.warning': 'TON network, USDT only — never EVM or Solana.',
  ...
  'workflows.scheduleEnable': 'Run automatically on a schedule',
  'workflows.nextRun': 'next run {time}',
  'workflows.scheduleRetired': 'already ran, one-off',
  ...
  'workflowRuns.runStepByStepAria': 'run {name} step by step',
  'workflowRuns.stopAria': 'stop {name}',
  'workflowRuns.startFailed': 'Could not start the run',
  'workflowRuns.actionFailed': 'Could not update the run',
  'workflowRuns.runFinished': '“{name}” finished',
  ...
  'workflowRuns.noRuns': 'No runs yet.',
  'workflowRuns.trigger.manual': 'manual',
  'workflowRuns.trigger.scheduled': 'scheduled',
  'workflowRuns.nextStep': 'Run next step',
  ...
  'shell.language': 'Language: {lang}',
  'shell.home': 'Hermes Control Center — to the dashboard',
  'shell.collapseSidebar': 'Collapse sidebar',
  'shell.updateAvailable': 'Update to {version}',
  'shell.updateInstructions': 'A newer release is available. Run this in the install directory:',
  'shell.copyCommand': 'Copy command',
  'shell.viewRelease': 'View release',
  ...
  // Bot Center
  'bots.new': 'New bot',
  'bots.stateActive': 'Active',
  'bots.statePaused': 'Paused',
  'bots.dmTo': 'DM to',
  'bots.chatWith': 'Chat with',
  'bots.dmChoose': 'Choose a bot…',
  'bots.dmTargetLabel': 'Target bot for direct message',
  'bots.dmPlaceholder': 'Message the bot…',
  'bots.dmSend': 'Send',
  'bots.dmSending': 'Sending…',
  'bots.dmSent': 'DM sent',
  'bots.dmFailed': 'DM failed',
  'bots.dmDelivered': 'bots replied',
  'bots.createTitle': 'Build a bot',
  'bots.createDesc':
    'A bot gets its own Hermes profile, so its model, skills, memory and conversations stay separate.',
  'bots.name': 'Bot name',
  'bots.profile': 'Hermes profile',
  'bots.profileHint': 'Technical profile name without spaces.',
  'bots.clone': 'Clone profile',
  'bots.cloneNone': 'Start fresh',
  'bots.description': 'Description',
  'bots.modelChoice': 'Model for this bot',
  'bots.modelInherit': 'Inherit Hermes default model',
  'bots.create': 'Create bot',
  'bots.created': 'Bot created',
  'bots.failed': 'Bot action failed',
  'bots.partial': 'Bot paused partially',
  'bots.stateChanged': 'Bot state updated',
  'bots.hidden': 'Bot hidden',
  'bots.roster': 'Fleet roster',
  'bots.archivedBots': 'Archived bots',
  'bots.activeBots': 'Active bots',
  'bots.showArchived': 'Show archive',
  'bots.restore': 'Restore',
  'bots.restored': 'Bot restored',
  'bots.profileBacked': 'Profile-backed',
  'bots.empty': 'No bots yet. Create the first identity for your Hermes fleet.',
  'rooms.title': 'Group Rooms',
  'rooms.desc': 'Multiple bots discuss the same message in one room.',
  'rooms.new': 'New room',
  'rooms.empty': 'No rooms yet. Create the first one.',
  'rooms.select': 'Select or create a room.',
  ...
  'rooms.messagePlaceholder': 'Message all bots …',
  'rooms.send': 'Send',
  'rooms.sending': 'Sending…',
  'rooms.you': 'You',
  'rooms.sendFailed': 'Send failed',
  'rooms.deliberate': 'Discuss',
  'rooms.deliberating': 'Discussing…',
  'rooms.deliberationFailed': 'Discussion failed',
  'rooms.editMembers': 'Edit members',
  'rooms.membersSaved': 'Members saved',
  'rooms.membersFailed': 'Failed to change members',
  'bots.select': 'Select a bot to operate it.',
  ...
  'bots.openChat': 'Open direct chat',
  'bots.chatCenterTitle': 'Bot Chats',
  'bots.chatCenterDesc': 'A dedicated chat area for your bots and their profiles.',
  'bots.avatar': 'Avatar',
  'bots.avatarEmoji': 'Emoji',
  'bots.avatarNone': 'Default',
  'bots.accent': 'Accent color',
  'bots.activeNow': 'Active right now',
  'bots.lastSeen': 'Last seen',
  'bots.save': 'Save',
  'bots.routines': 'Routines',
  'bots.noRoutines': 'No routines linked yet',
  'bots.routineSelect': 'Choose a cron job…',
  'bots.addRoutine': 'Add',
  'bots.removeRoutine': 'Remove routine',
  'bots.routineOn': 'On',
  'bots.routineOff': 'Off',
  'bots.newRoutine': 'Create new routine',
  'bots.routineName': 'Name (optional)',
  'bots.routineSchedule': 'Schedule (cron, e.g. 0 9 * * *)',
  'bots.routinePrompt': 'Task description',
  'bots.routineCreate': 'Create routine',
  'bots.routinePromptNeeded': 'Please enter a task description for the routine',
  'bots.routineCreated': 'Routine created',
  'bots.createWithRoutine': 'Also create a routine (cron job)?',
  'bots.chatRoster': 'Bots',
  'bots.manage': 'Manage bots',
  'bots.edit': 'Edit bot',
  'bots.archive': 'Archive bot',
  'bots.deleteForever': 'Delete permanently',
  'bots.deleteForeverConfirm': 'Permanently delete this bot and its Hermes profile?',
  'bots.deleteProtected': 'The launch profile cannot be permanently deleted.',
  'bots.updated': 'Bot updated',
  'bots.archived': 'Bot archived',
  'bots.deleted': 'Bot permanently deleted',
  'bots.modelChangeOptional': 'Leave empty to keep the current model.',
  'bots.pause': 'Pause bot',
  'bots.resume': 'Resume bot',
  'bots.pauseConfirm':
    'Pause this bot? Enabled messaging channels will be switched off and restored on resume.',
  'bots.hide': 'Hide from roster',
