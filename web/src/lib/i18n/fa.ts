...
export const fa: Dict = {
  ...
  'telegram.setup.auto': 'خودکار',
  'telegram.setup.manual': 'دستی',
  ...
  'telegram.setup.autoHint':
    'ربات متعلق به خودت را از طریق سرویس راه‌اندازی تلگرام هرمس می‌سازد — بدون کپی از BotFather. برای تأیید، تلگرام باز می‌شود؛ توکن و شناسه کاربری‌ات خودکار برمی‌گردند.',
  'telegram.setup.autoStart': 'ساخت خودکار ربات',
  'telegram.setup.waiting': 'در انتظار تأیید در تلگرام …',
  'telegram.setup.openInTelegram': 'باز کردن در تلگرام',
