...
export const fa: Dict = {
  ...
  'page.bots.desc': 'عامل‌های مبتنی بر پروفایل هرمس را از یک نمای ناوگان بسازید و اجرا کنید.',
  ...
  'settings.update.latest': 'به‌روزرسانی موجود است ({version})',
  'settings.update.available': 'به‌روزرسانی موجود است',
  'settings.update.current': '✓ به‌روز است (v{version})',
  'settings.update.running': 'در حال به‌روزرسانی…',
  'settings.update.uptodate': '✅ از قبل به‌روز است — چیزی برای نصب نیست',
  'settings.update.installed': '✅ به‌روزرسانی نصب شد — سرویس دوباره راه‌اندازی می‌شود',
  'settings.update.failed': '❌ به‌روزرسانی ناموفق بود',
  'settings.update.button': 'به‌روزرسانی کن',
  'settings.update.button.running': 'در حال به‌روزرسانی…',
  'settings.update.startedToast': 'به‌روزرسانی شروع شد',
  'settings.update.failedToast': 'به‌روزرسانی ناموفق بود',
  'settings.hermesUpdate.startedToast': 'به‌روزرسانی هرمس شروع شد',
  'settings.hermesUpdate.failedToast': 'به‌روزرسانی هرمس ناموفق بود',
  'settings.hermesUpdate.title': 'به‌روزرسانی هرمس',
  'settings.hermesUpdate.button': 'به‌روزرسانی هرمس',
  'settings.ccUpdate.title': 'به‌روزرسانی Control Center',
  'settings.ccTitle': 'Control Center',
  ...
  'workflows.scheduleEnable': 'اجرای خودکار طبق زمان‌بندی',
  'workflows.nextRun': 'اجرای بعدی {time}',
  'workflows.scheduleRetired': 'قبلاً اجرا شد، یک‌بار مصرف',
  ...
  'workflowRuns.noRuns': 'هنوز اجرایی وجود ندارد.',
  'workflowRuns.trigger.manual': 'دستی',
  'workflowRuns.trigger.scheduled': 'زمان‌بندی‌شده',
  'workflowRuns.nextStep': 'اجرای مرحله بعدی',
  ...
  'bots.dmSend': 'ارسال',
  'bots.dmSending': 'در حال ارسال…',
  'bots.dmSent': 'پیام ارسال شد',
  'bots.dmFailed': 'ارسال پیام شکست خورد',
  'bots.dmDelivered': 'بات‌ها پاسخ دادند',
  'bots.createTitle': 'ساخت بات',
  'bots.createDesc':
    'هر بات پروفایل هرمس جداگانه‌ای دارد؛ مدل، مهارت‌ها، حافظه و گفتگوها جدا می‌مانند.',
  'bots.name': 'نام بات',
  'bots.profile': 'پروفایل هرمس',
  'bots.profileHint': 'نام فنی پروفایل بدون فاصله.',
  'bots.clone': 'کلون پروفایل',
  'bots.cloneNone': 'شروع تازه',
  'bots.description': 'توضیح',
  'bots.modelChoice': 'مدل این بات',
  'bots.modelInherit': 'استفاده از مدل پیش‌فرض هرمس',
  'bots.create': 'ساخت بات',
  'bots.created': 'بات ساخته شد',
  'bots.failed': 'عملیات بات ناموفق بود',
  'bots.partial': 'بات به‌طور ناقص مکث شد',
  'bots.stateChanged': 'وضعیت بات به‌روزرسانی شد',
  'bots.hidden': 'بات پنهان شد',
  'bots.roster': 'ناوگان بات‌ها',
  'bots.archivedBots': 'بات‌های بایگانی‌شده',
  'bots.activeBots': 'بات‌های فعال',
  'bots.showArchived': 'نمایش بایگانی',
  'bots.restore': 'بازگردانی',
  'bots.restored': 'بات بازگردانی شد',
  'bots.profileBacked': 'مبتنی بر پروفایل',
  'bots.empty': 'هنوز باتی وجود ندارد. اولین هویت را برای ناوگان هرمس بسازید.',
  'rooms.title': 'اتاق‌های گروهی',
  'rooms.desc': 'چند بات درباره یک پیام در یک اتاق بحث می‌کنند.',
  'rooms.new': 'اتاق جدید',
  'rooms.empty': 'هنوز اتاقی وجود ندارد. اولین را بسازید.',
  'rooms.select': 'یک اتاق انتخاب یا بسازید.',
  'rooms.namePlaceholder': 'نام اتاق …',
  'rooms.create': 'ایجاد اتاق',
  'rooms.created': 'اتاق ساخته شد',
  'rooms.deleted': 'اتاق حذف شد',
  'rooms.delete': 'حذف اتاق',
  'rooms.messagePlaceholder': 'پیام به همه بات‌ها …',
  'rooms.send': 'ارسال',
  'rooms.sending': 'در حال ارسال…',
  'rooms.you': 'شما',
  'rooms.sendFailed': 'ارسال ناموفق بود',
  'rooms.deliberate': 'بحث',
  'rooms.deliberating': 'در حال بحث…',
  'rooms.deliberationFailed': 'بحث ناموفق بود',
  'rooms.editMembers': 'ویرایش اعضا',
  'rooms.membersSaved': 'اعضا ذخیره شد',
  'rooms.membersFailed': 'تغییر اعضا ناموفق بود',
  'bots.select': 'یک بات را برای مدیریت انتخاب کنید.',
  'bots.channels': 'کانال‌ها',
  'bots.skills': 'مهارت‌ها',
  'bots.model': 'مدل',
  'bots.gateway': 'گیت‌وی',
  'bots.online': 'آنلاین',
  'bots.offline': 'آفلاین',
  'bots.openChat': 'باز کردن گفتگوی مستقیم',
  'bots.chatCenterTitle': 'گفتگوهای بات‌ها',
  'bots.chatCenterDesc': 'بخش گفتگوی جداگانه برای بات‌ها و پروفایل‌های آن‌ها.',
  'bots.avatar': 'آواتار',
  'bots.avatarEmoji': 'ایموجی',
  'bots.avatarNone': 'پیش‌فرض',
  'bots.accent': 'رنگ تاکیدی',
  'bots.activeNow': 'اکنون فعال',
  'bots.lastSeen': 'آخرین فعالیت',
  'bots.save': 'ذخیره',
  'bots.routines': 'روتین‌ها',
  'bots.noRoutines': 'هنوز روتینی متصل نشده',
  'bots.routineSelect': 'انتخاب کران‌جاب…',
  'bots.addRoutine': 'افزودن',
  'bots.removeRoutine': 'حذف روتین',
  'bots.routineOn': 'روشن',
  'bots.routineOff': 'خاموش',
  'bots.newRoutine': 'ایجاد روتین جدید',
  'bots.routineName': 'نام (اختیاری)',
  'bots.routineSchedule': 'زمان‌بندی (کران، مثلاً 0 9 * * *)',
  'bots.routinePrompt': 'توضیح وظیفه',
  'bots.routineCreate': 'ایجاد روتین',
  'bots.routinePromptNeeded': 'لطفاً توضیح وظیفه برای روتین وارد کنید',
  'bots.routineCreated': 'روتین ایجاد شد',
  'bots.createWithRoutine': 'هم‌زمان یک روتین (کران‌جاب) بسازم؟',
  'bots.chatRoster': 'بات‌ها',
  'bots.manage': 'مدیریت بات‌ها',
  'bots.edit': 'ویرایش بات',
  'bots.archive': 'بایگانی بات',
  'bots.deleteForever': 'حذف دائمی',
  'bots.deleteForeverConfirm': 'این بات و پروفایل هرمس آن برای همیشه حذف شود؟',
  'bots.deleteProtected': 'پروفایل راه‌انداز را نمی‌توان برای همیشه حذف کرد.',
  'bots.updated': 'بات به‌روزرسانی شد',
  'bots.archived': 'بات بایگانی شد',
  'bots.deleted': 'بات برای همیشه حذف شد',
  'bots.modelChangeOptional': 'برای نگه‌داشتن مدل فعلی خالی بگذارید.',
  'bots.pause': 'مکث بات',
  'bots.resume': 'ادامهٔ بات',
  'bots.pauseConfirm':
    'این بات مکث شود؟ کانال‌های پیام‌رسان فعال خاموش و هنگام ادامه دوباره فعال می‌شوند.',
  'bots.hide': 'پنهان کردن از ناوگان',
