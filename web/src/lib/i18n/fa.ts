...
export const fa: Dict = {
  ...
  'page.workflows.desc':
    'دنباله‌های نام‌گذاری‌شده و مرتب از پرامپت‌ها و کارهای زمان‌بندی‌شده. زنجیره‌های متشکل از کارهای زمان‌بندی‌شده و یادداشت‌ها را اکنون می‌توان با دکمه ▶ به‌صورت دستی اجرا کرد؛ گام‌های پرامپت و اجرای خودکار در به‌روزرسانی بعدی می‌آیند.',
  'page.aufgaben.desc':
  ...
  'workflows.empty.desc':
    'پرامپت‌ها و کارهای زمان‌بندی‌شده را به یک دنباله نام‌گذاری‌شده و مرتب زنجیر کنید. زنجیره‌های کارهای زمان‌بندی‌شده و یادداشت‌ها را می‌توان همین حالا به‌صورت دستی اجرا کرد؛ گام‌های پرامپت در به‌روزرسانی بعدی اضافه می‌شوند.',
